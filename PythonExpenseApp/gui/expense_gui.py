...
class ExpenseGUI:
    """
    GUI for managing and recording expenses.
    """
    def __init__(self, root):
        """
        Initializes the Expense GUI window and its widgets.
        - Sets up input fields for amount, description, student name, and surname.
        - Provides buttons to search for a student and add an expense.
        - Displays a list of all expenses added in the session.
        """
        # Main window
        self.root = root
        ...
        # List to store Expense objects added in this session
        self.expenses = []

        # Input Panel for entering expense details
        ...
        # Entry for student surname (readonly, filled by search)
        ...
        # Button to search for student by name
        ...
        # Text area for displaying the list of expenses
    ...
    def search_student(self):
        ...
        - If found, fills the surname field with the student's surname.
        - If not found, shows an info message.
        - Uses the students table in the database.
        """
        ...
        if connection:
            try:
                ...
                if result:
                    ...
                    # Set the found surname in the entry
                    self.surname_var.set(surname)
                    # Optionally store student_id if needed for further logic
                else:
    ...
    def add_expense(self):
        """
        Adds a new expense to the list and saves it to the database.
        - Reads the amount and description from the input fields.
        - Validates the input.
        - Creates an Expense object and saves it to the database.
    ...
    def update_expense_list(self):
        """
        Updates the text area to show all expenses added in this session.
        """
